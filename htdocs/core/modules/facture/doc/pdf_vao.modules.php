...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_vao.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from vao model
 */
 ...
 */
class pdf_vao extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
