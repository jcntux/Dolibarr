...
class ICCashDeskPaymentCheque extends ICCashDeskPayment {
	...
	public function hookRender() {
		...
		$item = ICCashDeskField::text('bankname', 'Bank name', NULL, $options);
		$html .= ICCashDeskField::display($item);
		$item = ICCashDeskField::text('drawer', 'Cheque drawer', NULL, $options);
		$html .= ICCashDeskField::display($item);
		$item = ICCashDeskField::text('number', 'Cheque number', NULL, $options);
		$html .= ICCashDeskField::display($item);
